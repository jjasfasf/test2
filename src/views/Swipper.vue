...
<template>
   ...
   <el-card class="swiper-container">
      <div class="header">
        ...
        <el-popconfirm title="确定删除吗?" confirmButtonText="确认" cancelButtonText="取消" @confirm="handleDelete">
            <template #reference>
   ...
   <DialogAddSwiper ref="addSwiper" :reload="getCarousels" :type="state.type"></DialogAddSwiper>
    ...
    <el-table :load="state.loading" :data="state.tableData" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange"  ref="multipleTable">
