<template>
       ...
       <el-card class="add-container">
         <el-form :model="state.goodForm" :rules="state.rules" ref="goodRef" label-width="100px" class="goodForm">
          ...
          <el-form-item label="商品售价" prop="sellingPrice">
             <el-input type="number" style="width:300px" min="0" v-model="state.goodForm.sellingPrice" placeholder="请输入商品售价"></el-input>
          ...
          <el-form-item label="商品标签" prop="tag">
              <el-input style="width:300px" v-model="state.goodForm.tag" placeholder="请输入商品标签"></el-input>
          </el-form-item>
  ...
  <script setup>
    ...
    onMounted(()=>{
       ...
       instance.config.uoloadImgHeaders={
        token:state.token
       }
       ...
       if(id){
        axios.get(`/goods/${id}`).then(res=>{
           ...
           state.categoryId=goods.categoryId
