<template>
    ...
    <div class="login-container">
      ...
      <el-form label-position="top" :rules="state.rules" :model="state.ruleForm" ref="loginForm" class="login-form">
        <el-form-item label="账号" prop="username">
          <el-input type="text" v-model="state.ruleForm.username" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="密码" prop="password">
          <el-input type="password" v-model="state.ruleForm.password" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item>
  ...
  <script setup>
    ...
    const state=reactive({
        ...
        rules:{
            username:[{
             require: true,message:'账户不能为空' ,trigger:'blur'
            }],
            password:[{
